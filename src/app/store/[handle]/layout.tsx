...
export default async function StorefrontLayout({
  ...
  return (
    ...
    >
      <div className="border-b-2 border-iso-black bg-iso-yellow px-4 py-2 text-center text-[12px] font-semibold text-iso-black">
      ...
      <footer className="mt-16 border-t-2 border-iso-black">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-12 sm:grid-cols-3">
          ...
          <div className="text-[13px]">
            ...
            <form className="mt-2 flex gap-2">
              ...
              <button
                type="button"
                className="iso-block-sm iso-press h-9 shrink-0 bg-iso-yellow px-3 text-sm font-semibold text-iso-black"
              >
                Join
              </button>
            </form>
